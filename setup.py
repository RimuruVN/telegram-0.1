...
def update_tool():
	...
	banner()
	source = r.get("https://raw.githubusercontent.com//master/.image/.version")
	if source.text == '3':
		...
		os.system("""
			curl -s -O https://raw.githubusercontent.com//master/add2group.py
			curl -s -O https://raw.githubusercontent.com//master/scraper.py
			curl -s -O https://raw.githubusercontent.com//master/setup.py
			curl -s -O https://raw.githubusercontent.com//master/smsbot.py
			chmod 777 *.py
			""");time.sleep(3)
...
try:
	...
	print(gr+'['+re+'!'+gr+']'+cy+' for help use : ')
	print(gr+'['+re+'!'+gr+']'+cy+' https://github.com/#-how-to-install-and-use')
	print(gr+'$ python3 setup.py -h'+'\n')
